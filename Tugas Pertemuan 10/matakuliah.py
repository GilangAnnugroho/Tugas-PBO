...
class matakuliah:
    ...
    def update(self, id):
        self.conn = mydb()
        val = (self.__kodemk, self.__namamk, self.__sks, self.__kodeprodi, id)
    ...
    def updateBykodemk(self, kodemk):
        self.conn = mydb()
        val = (self.__namamkmk, self.__sks,kodemk)
...
"""Disini untuk Fungsi Menampilkan, Entry, Update Delete"""

"""
# Menampilkan semua data dari tabel matakuliah
A = matakuliah()
B = A.getAllData()
...
# Entry Data Baru Mata Kuliah
A = matakuliah()
A.kodemk = "C1CX322T"
A.namamk = "Pemrograman 2"
A.sks = "1"
A.simpan()
B = A.getAllData()
print("Entry Data")
